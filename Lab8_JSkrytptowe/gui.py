...
"")
        ...
        self.hostAddressEdit.setGeometry(QRect(840, 210, 171, 31))
        self.hostAddressEdit.setReadOnly(True)
...
"}")
        ...
        self.dateEdit.setGeometry(QRect(840, 270, 171, 31))
...
"}")
        ...
        self.resourceEdit.setGeometry(QRect(840, 450, 171, 31))
        ...
        self.resourceLabel.setGeometry(QRect(720, 460, 68, 19))
...
"}")
        ...
        self.sizeEdit.setGeometry(QRect(840, 510, 171, 31))
...
"}")
        ...
        self.fromDateEdit.setGeometry(QRect(110, 200, 131, 22))
